...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    FootiNavigationController *flipboardNavigationController = [[FootiNavigationController alloc] initWithRootViewController:vc];
    self.window.rootViewController = flipboardNavigationController;
